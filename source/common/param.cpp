...
#define CHECK(expr, msg) check_failed |= _confirm(param, expr, msg)
    ...
    CHECK((uint64_t)param->sourceWidth * param->sourceHeight > 142606336 && !param->bAllowNonConformance,
          "Input video resolution exceeds the maximum supported luma samples 142,606,336 (16384*8704) of Level 7.2, to override this limit, use --allow-non-conformance.");
